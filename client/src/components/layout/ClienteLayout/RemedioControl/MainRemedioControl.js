                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="card mb-4 shadow-sm">
                                <img width="100%" height="225" src={novalgina} alt="Novalgina" />
                                <div className="card-body">
                                    <p className="card-text"><b>Data da prescrição: </b> 18/02/2020</p>
                                    <p className="card-text"><b>Médico: </b> Dr. André Seiki</p>
                        ...
                        <div className="col-md-4">
                            <div className="card mb-4 shadow-sm">
                                ...
                                <div className="card-body">
                                    <p className="card-text"><b>Data da prescrição: </b> 09/01/2020</p>
                                    <p className="card-text"><b>Médico: </b> Dr. Luiz Augusto</p>
                        ...
                        <div className="col-md-4">
                            <div className="card mb-4 shadow-sm">
                                ...
                                <div className="card-body">
                                    <p className="card-text"><b>Data da prescrição: </b> 18/02/2020</p>
                                    <p className="card-text"><b>Médico: </b> Dr. Pedro</p>
                        ...
                        <div className="col-md-4">
                            <div className="card mb-4 shadow-sm">
                                ...
                                <div className="card-body">
                                    <p className="card-text"><b>Data da prescrição: </b> 18/02/2020</p>
                                    <p className="card-text"><b>Médico: </b> Dr. Igor</p>
                                    <p className="card-text"><b>Utilização: </b>Tomar 3x de 8 em 8 horas</p>
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="btn-group">
